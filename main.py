...
root= Tk()
root.title("Demoninstion Counter")
root.configure(bg="pink")
root.geometry("650x400")

upload=Image.open("mo.jpg")
upload=upload.resize((400,400))
image=ImageTk.PhotoImage(upload)
label=Label(root, image=image, bg="light blue")
label.place(x=180,y=20)

label1=Label(root, text="Hey User! Welcome to demonination counter application", bg="blue")
...
def topwin():
    top=Toplevel()
    top.title("Demonination Counter")
